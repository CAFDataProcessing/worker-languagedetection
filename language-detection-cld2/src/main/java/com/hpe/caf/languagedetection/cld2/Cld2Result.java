...
public class Cld2Result
{
    ...
    /**
     * is_reliable set true if the returned Language is some amount more probable than the second-best Language. Calculation is a complex
     * function of the length of the text and the different-script runs of text.
     */
    ...
    /**
     * convert an integer array to an array list of strings (for percent3 and language3)
     *
     * @param iArray
     * @return strings
     */
