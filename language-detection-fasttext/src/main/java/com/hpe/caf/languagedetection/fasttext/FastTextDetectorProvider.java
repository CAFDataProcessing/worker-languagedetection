...
/**
 * Provider implementation returning a FatTextDetector object
 */
public class FastTextDetectorProvider implements LanguageDetectorProvider {
    /**
     * returns a new FatTextDetector object
     *
