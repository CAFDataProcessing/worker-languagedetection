...
public class Cld2Detector implements LanguageDetector
{
    ...
    /**
     * Cld2 implementation of detectLanguage. This calls the Cld2Wrapper.detectLanguageSummaryWithHints and compiles the
     * LanguageDetectorResult using the Cld2Result obtained from the wrapper.
     *
    ...
    public LanguageDetectorResult detectLanguage(byte[] textBytes, LanguageDetectorSettings settings)
    {
        ...
        System.out.println("Language detection completed in " + (System.nanoTime() - startTime) + " ns, " + (System.nanoTime() - startTime) / 1_000 + " micro seconds.");
